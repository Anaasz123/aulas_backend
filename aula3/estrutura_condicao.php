...
<p>
    ...
    executada, dada condição.

    Se a condição for verdadeira (true) executa 
    a instrução 1, caso contrário executa a instrução 2.
    ...
    <?php
       ...
       minino 6 pontos em cada disciplina. Murilo tirou...
      ...
      notas menores que 3 são reprovados diretas.
